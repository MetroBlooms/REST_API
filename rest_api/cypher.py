...
#FOREACH (addresses IN [{address:'1234 N Oak Lane',city:'Saintly City',state:'MN',zipcode: '55466'}, {address:'4321 Winifred St SE',city:'Gorden Volley',state:'MN',zipcode:'55433'}]|
...
# create multiple nodes
addresses = gdb.merge(
    {'address':'1234 N Oak Lane','city':'Saintly City','state':'MN','zipcode': '55466'},
    {'address':'4321 Winifred St SE','city':'Gorden Volley','state':'MN','zipcode':'55433'}
)
